...
To build the final jar and optimize the micro2 application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v6.2.0/microservices-architecture/#consul
