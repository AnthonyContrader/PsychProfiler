...
public class AnswerDTO {
	...
	public AnswerDTO(int id_ans, int id_cand, int id_quest, int ans) {
		super();
		this.id_ans = id_ans;
	...
	public AnswerDTO(int id_cand, int id_quest, int ans) {
		super();
		this.id_cand = id_cand;
		this.id_quest = id_quest;
		this.ans = ans;
	...
	public String toString() {
		return "AnswerDAO [id_ans=" + id_ans + ", id_cand=" + id_cand + ", id_quest=" + id_quest + ", ans=" + ans + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
