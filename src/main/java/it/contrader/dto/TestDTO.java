...
public class TestDTO {
	...
	public TestDTO(int id, int idUser, String quest1, String ans1, String quest2, String ans2, String quest3,
			String ans3, String quest4, String ans4, String quest5, String ans5) {
		super();
		this.id = id;
		this.idUser = idUser;
		this.quest1 = quest1;
	...
	public TestDTO(int idUser, String quest1, String ans1, String quest2, String ans2, String quest3, String ans3,
	...
	public String toString() {
		return "TestDTO [id=" + id + ", idUser=" + idUser + ", quest1=" + quest1 + ", ans1=" + ans1 + ", quest2="
				+ quest2 + ", ans2=" + ans2 + ", quest3=" + quest3 + ", ans3=" + ans3 + ", quest4=" + quest4 + ", ans4="
				+ ans4 + ", quest5=" + quest5 + ", ans5=" + ans5 + "]";
	}
