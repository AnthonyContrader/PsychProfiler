...
public class Question {
	...
	public Question(int id, String args, String quest, String ans1, String ans2, String ans3, String ans4) {
		super();
		this.id = id;
		this.args = args;
		this.quest = quest;
	...
	public Question(String args, String quest, String ans1, String ans2, String ans3, String ans4) {
		super();
		this.args = args;
		this.quest = quest;
		this.ans1 = ans1;
	...
	public String toString() {
		return "Question [id=" + id + ", args=" + args + ", quest=" + quest + ", ans1=" + ans1 + ", ans2=" + ans2
				+ ", ans3=" + ans3 + ", ans4=" + ans4 + "]";
	}
	@Override
	public int hashCode() {
