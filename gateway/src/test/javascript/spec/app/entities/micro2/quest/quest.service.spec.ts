...
describe('Service Tests', () => {
  describe('Quest Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(QuestService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Quest(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Quest', async () => {
        const returnedFromService = Object.assign(
          {
            args: 'BBBBBB',
            quest: 'BBBBBB',
