...
import { CandComponent } from 'app/entities/micro1/cand/cand.component';
import { CandService } from 'app/entities/micro1/cand/cand.service';
import { Cand } from 'app/shared/model/micro1/cand.model';

describe('Component Tests', () => {
  describe('Cand Management Component', () => {
    let comp: CandComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CandComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cands[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
