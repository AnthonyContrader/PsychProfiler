...
import { QuestComponent } from 'app/entities/micro2/quest/quest.component';
...
describe('Component Tests', () => {
  describe('Quest Management Component', () => {
    let comp: QuestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QuestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.quests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
